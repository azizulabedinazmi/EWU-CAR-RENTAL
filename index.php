      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <br><br><br><br><br>
            <h2 style="color:rgb(144, 18, 255);"><br></h2>
            <h2 style="color:rgb(144, 18, 255);">Find the ideal car for you.</h2>
            <h3 style="color:rgb(15, 227, 255);">We have more cars for you to choose. </h3>
        </div>
      </div>
    </div>
  </div>
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/azmi-dealer-logo.jpg" alt="" /> </div>
