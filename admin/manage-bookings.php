						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT tblusers.FullName, tblbrands.BrandName, tblvehicles.VehiclesTitle, tblbooking.FromDate, tblbooking.ToDate, tblbooking.message, tblbooking.VehicleId as vid, tblbooking.Status, tblbooking.PostingDate, tblbooking.id, tblbooking.with_driver, tblbooking.gps, tblbooking.child_seat, tblbooking.additional_insurance 
              FROM tblbooking 
...
if($query->rowCount() > 0)
{
    ...
    { ?>	
        <tr>
            ...
            <td><?php echo $result->with_driver ? 'Yes' : 'No'; ?></td>
            <td><?php echo $result->gps ? 'Yes' : 'No'; ?></td>
            <td><?php echo $result->child_seat ? 'Yes' : 'No'; ?></td>
            <td><?php echo $result->additional_insurance ? 'Yes' : 'No'; ?></td>
        </tr>
    <?php $cnt = $cnt + 1; 
    }
} ?>
