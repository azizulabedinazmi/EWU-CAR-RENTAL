...
if(isset($_POST['submit']))
{
    ...
    $additional_insurance = isset($_POST['additional_insurance']) ? 1 : 0;

    $sql = "INSERT INTO tblbooking(userEmail, VehicleId, FromDate, ToDate, message, Status, with_driver, gps, child_seat, additional_insurance) 
            VALUES(:useremail, :vhid, :fromdate, :todate, :message, :status, :with_driver, :gps, :child_seat, :additional_insurance)";
    ...
    $query->bindParam(':with_driver', $with_driver, PDO::PARAM_INT);
    $query->bindParam(':gps', $gps, PDO::PARAM_INT);
    $query->bindParam(':child_seat', $child_seat, PDO::PARAM_INT);
    $query->bindParam(':additional_insurance', $additional_insurance, PDO::PARAM_INT);
    $query->execute();
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
                <label><input type="checkbox" name="with_driver"> With Driver + ৳1000 Per Day</label>
              <label><input type="checkbox" name="gps"> GPS</label>
              <label><input type="checkbox" name="child_seat"> Child Seat</label>
              <label><input type="checkbox" name="additional_insurance"> Additional Insurance</label>
            </div>
